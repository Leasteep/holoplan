...
public class VRManipulation : MonoBehaviour {
	...
	void Update () {
		if(_leftControllerPressed && !_rightControllerPressed)
        {
            ...
            _leftControllerManipObject.transform.position -= MoveStrength * new Vector3(controllerPosDelta.x, 0, controllerPosDelta.z);
        ...
        else if(!_leftControllerPressed && _rightControllerPressed)
        {
            ...
            _rightControllerManipObject.transform.position -= MoveStrength * new Vector3(controllerPosDelta.x, 0, controllerPosDelta.z);
        ...
        else if(_leftControllerPressed && _rightControllerPressed)
        {
            if(_leftControllerManipObject == _rightControllerManipObject)
            {
                ...
                */
                ...
                _leftControllerManipObject.transform.rotation = _leftControllerManipObject.transform.rotation * Quaternion.Euler(0, rot, 0);
                _leftControllerManipObject.transform.localScale += new Vector3(1, 0, 1) * scale * ScaleStrength;
